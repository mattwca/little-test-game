...
public class RenderingSystem : IRenderSystem
{
    ...
    public RenderingSystem(ContentManager contentManager, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch, EntityManager entityManager, LightSystem lightSystem)
    {
